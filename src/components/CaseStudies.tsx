        ...
        <div className="grid grid-cols-1 gap-5 px-5 sm:gap-6 sm:px-8 md:grid-cols-2 lg:gap-7 lg:px-12">
          <article>
            <div className="group relative aspect-[329/246] cursor-pointer overflow-hidden rounded-2xl bg-[#1a1d2e]">
              ...
              />
              <div className="absolute bottom-4 left-4 flex h-9 w-9 items-center overflow-hidden rounded-full bg-white transition-all duration-300 ease-in-out group-hover:w-[148px] transform-gpu">
                <span className="max-w-0 overflow-hidden whitespace-nowrap text-[13px] font-medium text-gray-900 opacity-0 transition-all delay-100 duration-300 ease-in-out group-hover:mr-2 group-hover:max-w-[110px] group-hover:opacity-100 transform-gpu">
                  Learn more
                </span>
                <LinkIcon className="shrink-0 -rotate-45 transition-transform duration-300 ease-in-out group-hover:rotate-0 transform-gpu will-change-transform" />
              </div>
            </div>
          ...
          <article>
            <div className="group relative aspect-square cursor-pointer overflow-hidden rounded-2xl bg-[#6b6b6b]">
              <video
                ...
                className="h-full w-full object-cover"
              />
              <div className="absolute bottom-4 left-4 flex h-9 w-9 items-center overflow-hidden rounded-full bg-gray-900 transition-all duration-300 ease-in-out group-hover:w-[168px] transform-gpu">
                <span className="max-w-0 overflow-hidden whitespace-nowrap text-[13px] font-medium text-white opacity-0 transition-all delay-100 duration-300 ease-in-out group-hover:mr-2 group-hover:max-w-[120px] group-hover:opacity-100 transform-gpu">
                  View case study
                </span>
                <ArrowRight
                  size={14}
                  className="shrink-0 text-white -rotate-45 transition-transform duration-300 ease-in-out group-hover:rotate-0 transform-gpu will-change-transform"
                />
              </div>
            </div>
            <p className="mt-4 text-[13px] leading-relaxed text-gray-600 sm:text-[14px]">
